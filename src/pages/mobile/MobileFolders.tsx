    ...
    if (folderStations.length === 0) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <Button onClick={() => navigate("/m/folders")} variant="ghost" className="mb-4">
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <Button onClick={() => navigate("/m")} variant="ghost" className="mb-4">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to Player
          </Button>
        ...
        {folders.length === 0 ? (
          ...
          <div className="space-y-3">
            {folders.map((folder) => (
              <button
                key={folder.id}
                onClick={() => navigate(`/m/folders?folder=${folder.id}`)}
